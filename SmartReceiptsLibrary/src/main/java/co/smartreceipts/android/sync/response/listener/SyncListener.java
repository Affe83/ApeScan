...
public interface SyncListener<T extends Syncable> {
    ...
    /**
     * Gets the class type this listener is intended for
     *
     * @return the class type for this listener
     */
    @NonNull
     ...
     * @param result the {@link co.smartreceipts.android.sync.response.SyncResponse} that was received
     */
     ...
     *
     * @param type      the {@link SyncRequestType} of the request
     * @param exception the {@link co.smartreceipts.android.sync.response.SyncError}, which details why the sync failed
     */
